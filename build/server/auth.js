...
function AuthConfig() {
    ...
    var opts = {
        ...
        jwtFromRequest: passport_jwt_1.ExtractJwt.fromAuthHeaderWithScheme('JWT') //ExtractJwt.fromAuthHeaderAsBearerToken() - Desse modo se usa o Bearer ao passar o token 
    };
